...
echo ""
echo "NEXT STEPS:"
echo "  install.sh (from the project root) drives 02-flash-kernel.sh, reboots,"
echo "  and provisions -- 02 asks you to confirm before writing the boot"
echo "  partition, and never loads a new driver for you."
echo ""
echo "  Running 02 by hand instead (from THIS PROJECT'S environment, not this"
echo "  chroot):"
...
echo ""
echo "  Either way:"
echo "   - Review any new/changed driver source against this tree's ACTUAL"
echo "     headers before flashing, and have recovery-mode/serial-console"
echo "     access ready (02 reminds you too)."
echo "   - Test any NEWLY-built driver over SSH before wiring it to load"
echo "     automatically at boot (see its Kconfig help text). Example:"
